...
case "ConfirmUpdate": {
    $update_q = "UPDATE client SET client_fname = ?,client_lname = ?, client_street = ?, client_suburb = ?, client_state = ?, client_pcode = ?, client_email = ?,client_mobile = ? WHERE client_id = $pid";
